...
def main():
    ...
    res = calculate_abfe_gmx(input_dir=args.gmx_files_root_dir, out_root_folder_path=args.output_dir_path,
                   ...
                   submit=args.submit, use_gpu=not bool(args.nogpu), hybrid_job=not bool(args.nohybrid),
