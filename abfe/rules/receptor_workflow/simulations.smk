...
rule fep_ligand:
    ...
    output:
        out_dg=approach_path+"/{ligand_name}/{replica}/ligand/fep/ana/dg_results.csv"
    shell:
        """
            cd {input.output_dir}
            ./job_ligand.sh
...
rule fep_complex:
    input:
        ...
        in_complex_top = approach_path + "/{ligand_name}/input/complex/complex.gro",
        output_dir = approach_path + "/{ligand_name}/{replica}/complex"
    output:
        out_dg=approach_path + "/{ligand_name}/{replica}/complex/fep/ana/dg_results.csv",
...
rule calculate_ABFE:
    input:
        out_dg_complex=approach_path + "/{ligand_name}/{replica}/complex/fep/ana/dg_results.csv",
        out_dg_ligand=approach_path + "/{ligand_name}/{replica}/ligand/fep/ana/dg_results.csv",
