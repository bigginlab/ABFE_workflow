...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', "--ligand_mol_dir",  help='Input ligand(s) sdf file path', required=True, type=str) 
    parser.add_argument('-o', "--output_dir_path",  help='Output approach folder', required=True, type=str)
    parser.add_argument('-c', "--cofactor_mol_path", help='Input cofactor(s) sdf file path', required=False, default=None, type=str)
    ...
    mol_paths = glob.glob(os.path.join(args.ligand_mol_dir,"*.sdf"))
